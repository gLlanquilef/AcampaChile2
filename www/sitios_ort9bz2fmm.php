...
<table width="100%">
    ...
    <tr>
      <td width="10%" align="center">Numero Sitio</td>
      <td width="15%" align="center">Camping</td>
      <td width="15%" align="center">Estado</td>
      <td width="10%" align="center">Disponible</td>
      <td width="10%" align="center">Ocupado
      <input type="hidden" name="cantidad" id="hiddenField" value="6" /></td>
      <td width="20%" align="center">Fecha Entrada</td>
      <td type="datetime" name="fecha_salida"width="20%" align="center">Fecha de Salida</td> 
  </tr>
...
$NUM = $NUM + 1;
    ...
    <footer>
		<div align='center'>
		  <p title='Created By AcampaChile Team'>AcampaChile Copyright (C) 2015.</p>
		</div>
	</footer>
</body>
</html>
