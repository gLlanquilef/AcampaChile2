					...
					<nav id="nav">
						<ul>
							<li class="active">
								...
								<a href="registra_usuario.php">Registrar usuario</a>
				...
				<div class="container">
					<table class="table table-condensed">
						<tr>
							...
							<th width="40%" align="center">Camping</th>
							<th width="25%" align="center">Estado</th>
							<th type="datetime" name="fecha_salida" width="25%" align="center">Fecha de Salida</th> 
						</tr>
					</table>
				</div>
				<div class="container">
