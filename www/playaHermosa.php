...
<html>
	...
	<body>
		<div id="background">
			...
			<!--Main body-->
			<div id="main">
				<h1>Camping</br>Playa Hermosa<h1>
			</div>
			<!--/Main body-->
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="col-md-8">
							<h3>Puerto Varas, Comuna de Puerto Varas, Región de Los Lagos.</h3>
						</div>
					</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-8">
							<h3>Electricidad, Baños, Duchas, Estacionamiento, Agua potable.</h3>
						</div>
					</div>
					<!-- Elemento 6-->
					<div class="col-md-12">
						...
						<div class="col-md-8">
							<h3>Camping ubicado a lado del lago, 100% confiable y seguro. Visitenos.</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div id="cbp-fwslider" class="cbp-fwslider">
					<ul>
						<li><a href="#"><img src="images/galleryImages/playaHermosa1.jpg" alt="img01"/></a></li>
						<li><a href="#"><img src="images/galleryImages/playaHermosa2.jpg" alt="img02"/></a></li>
						<li><a href="#"><img src="images/galleryImages/playaHermosa3.jpg" alt="img03"/></a></li>
					</ul>
				</div>
			</div>
			<!--/Gallery slider-->
	...
	<script>
		...
		function getDirections() {
			...
			var start =  latlon;        
			var end =  new google.maps.LatLng(-41.317681,-72.9663725);
			if (!start || !end) {
